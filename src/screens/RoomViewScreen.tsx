...
import { MoreHorizontal, PaintBucket, RotateCw } from "lucide-react";
    ...
    <div className="mx-auto min-h-[100dvh] max-w-md bg-pv-bg pb-8">
      ...
      <div className="px-4">
        ...
        <div className="mt-4 flex justify-center gap-3">
          <button type="button" className="flex h-11 w-11 items-center justify-center rounded-full bg-pv-surface text-pv-charcoal shadow-sm">
            <RotateCw className="h-5 w-5" />
          </button>
          <button type="button" className="flex h-11 w-11 items-center justify-center rounded-full bg-pv-purple text-white shadow-[0_8px_20px_rgba(99,102,241,0.35)]">
            <span className="text-xs font-bold">3D</span>
          </button>
        </div>

        <div className="mt-5 rounded-2xl border border-pv-border bg-pv-surface p-4 shadow-pv">
          <div className="grid grid-cols-2 gap-4">
            ...
            <MetricCard
              ...
              icon={<PaintBucket className="h-5 w-5 text-pv-purple" />}
            />
          </div>

          <div className="mt-5 flex gap-2 border-b border-pv-border">
